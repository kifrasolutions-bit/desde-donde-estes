...
FLUJO_ORDEN = [
    ...
    "Vendedores ambulantes de helados", "POA", "Florez Buenaños", "Natalia Campo",
    ...
    "Los Primos Barbershop", "Pastor Wilmer",
    ...
    "Emerson Cuesta", "La Esquina", "Fedetranscarga", "Nidia Góngora",
    "Felipe Rios", "Felipe Ríos", "Justice for Colombia", "Liga Radio Quindío",
    "Arturo Calle", "Habitantes de Buenaventura", "Amigos de Colombia",
    "Jose Andres", "José Andrés", "Susana María Ramírez", "Uber",
    "Choripana", "Giro de Rigo", "Santa Sede", "Juan David Berrío", "Libertario",
